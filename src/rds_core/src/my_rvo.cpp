...
void MyRVO::computeCoordinativeVelocityObstacles(const Circle& o_1, const Circle& o_2,
...
void MyRVO::computeConvexRVO(const Vec2& relative_position, const Vec2& relative_velocity_pref,
